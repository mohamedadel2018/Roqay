  ...
  use  AuthenticatesUsers ;
    ...
    //  validate for Login Admin form
          $request->validate([
            ...
            return redirect('admin/login')->withInput($request->only('email'))->with('error','You Are not have permisstion to login this Page');
            }}
        ...
        public function destroy($id)
        {
            $album = album::find($id);
            $album->delete();
            return  redirect()->route('users.show.album')->with('success','Album Delete Successfully');
